...
# clients
PARAM1 = list(numpy.arange(384, 768, 128))

# ratio
PARAM2 = list(numpy.arange(0, 1, 0.2))
...
krico_csv_file = kricocsv.CsvFile(new_file=True,
                                  ...
                                  krico_csv_filename="KRICO-predict-load-test-caching.csv")

for p1, p2, p3 in itertools.product(PARAM1, PARAM2, PARAM3):
    krico_predict_file.update_workload_params(workload_class="caching",
                                              image_name="wrkld-caching-redis",
                                              param1=p1,
                                              param2=p2,
                                              param3=p3,
                                              param4=0)
