...
# clients
PARAM1 = list(numpy.arange(1, 17000, 1000))
...
krico_csv_file = kricocsv.CsvFile(new_file=True,
                                  ...
                                  krico_csv_filename="KRICO-predict-load-test-webserving.csv")

for p1 in PARAM1:
    krico_predict_file.update_workload_params(workload_class="webserving",
                                              image_name="wrkld-webserving",
                                              param1=p1,
                                              param2=0,
                                              param3=0,
                                              param4=0)
