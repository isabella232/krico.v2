...
# clients
PARAM1 = list(numpy.arange(10, 1000, 100))

# bitrate
PARAM2 = list(numpy.arange(744, 8166, 1024))
...
krico_csv_file = kricocsv.CsvFile(new_file=True,
                                  ...
                                  krico_csv_filename="KRICO-predict-load-test-streaming.csv")

for p1, p2 in itertools.product(PARAM1, PARAM2):
    krico_predict_file.update_workload_params(workload_class="streaming",
                                              image_name="wrkld-streaming-darwin",
                                              param1=p1,
                                              param2=p2,
                                              param3=0,
                                              param4=0)
